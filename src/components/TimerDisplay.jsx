...
const TimerDisplay = ({ 
  ...
  return (
    <div className="timer-display">
      {/* 音频设置按钮 - 左上角 */}
      <button className="settings-icon audio-settings-icon" onClick={onOpenAudioSettings} title="音频设置">
      ...
      {/* 计时器设置按钮 - 右上角 */}
      <button className="settings-icon timer-settings-icon" onClick={onOpenTimerSettings} title="计时器设置">
        <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
